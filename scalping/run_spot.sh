...
#declare -a excluded_symbols_regex="BTCUSDT BTCSTUSDT BNBUSDT ETHUSDT LTCUSDT XRPUSDT TUSDUSDT GBPUSDT EURUSDT BUSDUSDT BTCBUSD BTCSTBUSD BNBBUSD ETHBUSD LTCBUSD TUSDBUSD GBPBUSD EURBUSD USDTBUSD"
declare -a excluded_symbols_regex="TUSDUSDT GBPUSDT EURUSDT BUSDUSDT BTCSTUSDT BUSDUSDT GBPBUSDT EURBUSDT USDTBUSD"

python get_symbols.py -q ${2}

declare -a symbol_list
while read line; do
    symbol_list+=($line)
done < symbols_spot_${2}.txt
