...
declare -a arr_symbols=("LPTUSDT" "TRBUSDT" "RLCUSDT" "PEOPLEUSDT" "ROSEUSDT" "FLOWUSDT" "UNFIUSDT" "GALUSDT" "BLZUSDT")
...
run_Backtesting() {
    ...
    echo Backtesting.py -r $_runid --startyear $startyear --startmonth $startmonth --startday $startday --wfo_training_period $wfo_training_period -y $_strategyid -e $exchange -s $_symbol -t $_timeframe
